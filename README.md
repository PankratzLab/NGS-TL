...
5. [estimateTL.sh](https://github.com/PankratzLab/NGS-TL/blob/main/scripts/estimateTL.sh):  Estimate TL using mean coverage of GC bins from step 2 and the number of TL reads from step 4. A TL estimate is computed for each TL_READS_AT_K*. 
